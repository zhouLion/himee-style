...
export type TBodyOfsaveUsingPOST_9 = ApplicationSaveDTO;
export type TResponseOfsaveUsingPOST_9 = R_Application_;
export type TBodyOfupdateUsingPUT_9 = ApplicationUpdateDTO;
export type TResponseOfupdateUsingPUT_9 = R_Application_;
export type TBodyOfdeleteUsingDELETE_9 = number[];
export type TResponseOfdeleteUsingDELETE_9 = R_boolean_;
export type TBodyOfupdateAllUsingPUT_9 = Application;
export type TResponseOfupdateAllUsingPUT_9 = R_Application_;
export type TResponseOfclearCacheUsingPOST = R_boolean_;
export type TBodyOfexportExcelUsingPOST_9 = PageParams_ApplicationPageQuery_;
...
export type TBodyOfpageUsingPOST_9 = PageParams_ApplicationPageQuery_;
export type TResponseOfpageUsingPOST_9 = R_IPage_Application__;
export type TBodyOfpreviewUsingPOST_9 = PageParams_ApplicationPageQuery_;
export type TResponseOfpreviewUsingPOST_9 = R_string_;
export type TBodyOfqueryUsingPOST_9 = Application;
export type TResponseOfqueryUsingPOST_9 = R_List_Application__;
export type TResponseOfrefreshCacheUsingPOST = R_boolean_;
export interface TPathOfgetUsingGET_9 {
    // 主键
    id?: number;
}
export type TResponseOfgetUsingGET_9 = R_Application_;
export type TBodyOfsaveUsingPOST_10 = GlobalUserSaveDTO_1;
export type TResponseOfsaveUsingPOST_10 = R_User_;
export type TBodyOfupdateUsingPUT_10 = GlobalUserUpdateDTO;
...
export interface TQueryOfdeleteUsingDELETE_10 {
    // 主键id
    "ids[]"?: string[];
    // 企业编码
    tenantCode?: string;
...
export type TBodyOfexportExcelUsingPOST_10 = PageParams_GlobalUserSaveDTO_;
...
export type TBodyOfpageUsingPOST_10 = PageParams_GlobalUserSaveDTO_;
export type TResponseOfpageUsingPOST_10 = R_IPage_User__;
export type TBodyOfpreviewUsingPOST_10 = PageParams_GlobalUserSaveDTO_;
...
export type TResponseOfgetUsingGET_10 = R_User_;
export type TBodyOfsaveUsingPOST_11 = MenuSaveDTO;
export type TResponseOfsaveUsingPOST_11 = R_Menu_;
export type TBodyOfupdateUsingPUT_11 = MenuUpdateDTO;
export type TResponseOfupdateUsingPUT_11 = R_Menu_;
export type TBodyOfdeleteUsingDELETE_12 = number[];
export type TResponseOfdeleteUsingDELETE_12 = R_boolean_;
export type TBodyOfupdateAllUsingPUT_11 = Menu;
export type TResponseOfupdateAllUsingPUT_11 = R_Menu_;
export type TResponseOfclearCacheUsingPOST_1 = R_boolean_;
export type TBodyOfexportExcelUsingPOST_11 = PageParams_Menu_;
...
export type TBodyOfpageUsingPOST_11 = PageParams_Menu_;
export type TResponseOfpageUsingPOST_11 = R_IPage_Menu__;
export type TBodyOfpreviewUsingPOST_11 = PageParams_Menu_;
export type TResponseOfpreviewUsingPOST_11 = R_string_;
export type TBodyOfqueryUsingPOST_11 = Menu;
export type TResponseOfqueryUsingPOST_11 = R_List_Menu__;
...
export type TResponseOfgetUsingGET_11 = R_Menu_;
export interface TQueryOflistUsingPOST {
    // name
    name?: string;
}
export type TResponseOflistUsingPOST = R_List_Online__;
export type TBodyOfpageUsingPOST_12 = PageParams_Online_;
export type TResponseOfpageUsingPOST_12 = R_IPage_Online__;
...
export type TBodyOfsaveUsingPOST_12 = ResourceSaveDTO;
export type TResponseOfsaveUsingPOST_12 = R_Resource_;
export type TBodyOfupdateUsingPUT_12 = ResourceUpdateDTO;
export type TResponseOfupdateUsingPUT_12 = R_Resource_;
export type TBodyOfdeleteUsingDELETE_13 = number[];
export type TResponseOfdeleteUsingDELETE_13 = R_boolean_;
export type TBodyOfupdateAllUsingPUT_12 = Resource;
export type TResponseOfupdateAllUsingPUT_12 = R_Resource_;
...
export type TBodyOfexportExcelUsingPOST_12 = PageParams_Resource_;
...
export type TBodyOfpageUsingPOST_13 = PageParams_Resource_;
export type TResponseOfpageUsingPOST_13 = R_IPage_Resource__;
export type TBodyOfpreviewUsingPOST_12 = PageParams_Resource_;
export type TResponseOfpreviewUsingPOST_12 = R_string_;
export type TBodyOfqueryUsingPOST_12 = Resource;
export type TResponseOfqueryUsingPOST_12 = R_List_Resource__;
export type TResponseOfrefreshCacheUsingPOST_2 = R_boolean_;
export interface TPathOfgetUsingGET_12 {
    // 主键
    id?: number;
}
export type TResponseOfgetUsingGET_12 = R_Resource_;
export type TBodyOfsaveUsingPOST_13 = RoleSaveDTO_1;
export type TResponseOfsaveUsingPOST_13 = R_Role_;
export type TBodyOfupdateUsingPUT_13 = RoleUpdateDTO;
export type TResponseOfupdateUsingPUT_13 = R_Role_;
export type TBodyOfdeleteUsingDELETE_14 = number[];
export type TResponseOfdeleteUsingDELETE_14 = R_boolean_;
export type TBodyOfupdateAllUsingPUT_13 = Role;
export type TResponseOfupdateAllUsingPUT_13 = R_Role_;
...
export type TBodyOfexportExcelUsingPOST_13 = PageParams_RolePageQuery_;
...
export type TBodyOfpageUsingPOST_14 = PageParams_RolePageQuery_;
export type TResponseOfpageUsingPOST_14 = R_IPage_Role__;
export type TBodyOfpreviewUsingPOST_13 = PageParams_RolePageQuery_;
export type TResponseOfpreviewUsingPOST_13 = R_string_;
export type TBodyOfqueryUsingPOST_13 = Role;
export type TResponseOfqueryUsingPOST_13 = R_List_Role__;
...
export type TResponseOfgetUsingGET_13 = R_Role_;
export interface TPathOfqueryByRoleIdUsingGET {
    // roleId
    roleId: number;
}
export type TResponseOfqueryByRoleIdUsingGET = R_List_RoleAuthority__;
export type TBodyOfsaveUsingPOST_14 = UserSaveDTO;
export type TResponseOfsaveUsingPOST_14 = R_User_;
export type TBodyOfupdateUsingPUT_14 = UserUpdateDTO;
export type TResponseOfupdateUsingPUT_14 = R_User_;
export type TBodyOfdeleteUsingDELETE_15 = number[];
export type TResponseOfdeleteUsingDELETE_15 = R_boolean_;
export type TBodyOfupdateAllUsingPUT_14 = User;
export type TResponseOfupdateAllUsingPUT_14 = R_User_;
...
export type TBodyOfexportExcelUsingPOST_14 = PageParams_UserPageQuery_;
...
export type TBodyOfpageUsingPOST_15 = PageParams_UserPageQuery_;
export type TResponseOfpageUsingPOST_15 = R_IPage_User__;
...
export type TBodyOfpreviewUsingPOST_14 = PageParams_UserPageQuery_;
export type TResponseOfpreviewUsingPOST_14 = R_string_;
export type TBodyOfqueryUsingPOST_14 = User;
export type TResponseOfqueryUsingPOST_14 = R_List_User__;
...
export type TResponseOfgetUsingGET_14 = R_User_;
