...
interface IApiFn {
    ...
    (url: "/anno/check"): {
        /**
         * @description 验证验证码 checkUsingGET_4
         * 登录接口
         */
        get(options: {
