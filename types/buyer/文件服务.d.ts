...
type TBodyOfpageUsingPOST_5 = PageParams_FileFileParamVO_;
type TResponseOfpageUsingPOST_5 = R_IPage_File__;
type TBodyOfqueryUsingPOST_4 = File;
type TResponseOfqueryUsingPOST_4 = R_List_File__;
interface TPathOfgetUsingGET_5 {
    id?: number;
}
type TResponseOfgetUsingGET_5 = R_File_;
...
export { AppendixResultVO, File, FileFileParamVO, FileFileResultVO, IApiFn, IPage_File_, Map_long_string_, Map_string_string_, PageParams_FileFileParamVO_, R_FileFileResultVO_, R_File_, R_IPage_File__, R_List_AppendixResultVO__, R_List_File__, R_Map_long_string__, R_Map_string_string__, R_boolean_, RequestProvider, TBodyOfdeleteUsingDELETE_5, TBodyOfdownloadUsingPOST, TBodyOffindUrlByIdUsingPOST, TBodyOffindUrlByPathUsingPOST, TBodyOfpageUsingPOST_5, TBodyOfqueryUsingPOST_4, TFormDataOfuploadUsingPOST, TPathOfgetUsingGET_5, TQueryOflistByBizIdUsingPOST, TQueryOfuploadUsingPOST, TResponseOfdeleteUsingDELETE_5, TResponseOfdownloadUsingPOST, TResponseOffindUrlByIdUsingPOST, TResponseOffindUrlByPathUsingPOST, TResponseOfgetUsingGET_5, TResponseOflistByBizIdUsingPOST, TResponseOfpageUsingPOST_5, TResponseOfqueryUsingPOST_4, TResponseOfuploadUsingPOST, createRequest };
